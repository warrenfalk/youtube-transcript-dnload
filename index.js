...
async function fetchTranscript(videoId, apiKey) {
    // This one works with autogenerated spanish
    //const langsHex = `0a ${stringToHexWithLength('asr')} 12 ${stringToHexWithLength('es')} 1a 00`
    // This one works with manual spanish latinoamerica (es-419)
    const langsBase64 = hexToBase64(`0a ${stringToHexWithLength('')} 12 ${stringToHexWithLength('es-419')} 1a ${stringToHexWithLength('')}`);
    const paramsHex = `
